...
//         throw new Error("Member ID or Refresh Token not found");
//       }

//       const response = await fetch(
//         `${BASE_URL}/follows/follower?memberId=${memberId}`,
//         {
//           headers: {
...
//   const createChatRoom = async (follower: Follower) => {
//     try {
//       const apiRoom = await chatApi.createChatRoom(follower.id);
...
//         <Image source={{ uri: item.imagePath }} style={styles.profileImage} />
//         <View>
//           <Text style={styles.userEmail}>{item.nickname}</Text>
//         </View>
//       </View>
//     </TouchableOpacity>
//   );
